...
- **Prices are ZAR, set 2026-09-23 by the service-first decision memo: Solo R4,999 / Studio R9,999 / Sovereign R15,000 monthly; annual 25% off.** ZW/ZM buyers pay sats via coinos or the ZAR-equivalent rate. Billing is enforced fail-closed (`hunta billing grant`).
