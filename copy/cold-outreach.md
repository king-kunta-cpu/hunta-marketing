...
Audience A = the buyer: career coaches, outplacement consultants, CV-writing studios,
university career centres, recruitment mentors in ZA/ZW/ZM.
Audience B = the end beneficiary: job seekers (coaches forward or you recruit pilots).

---

## Email 1 — the coach (first touch)

Subjects (pick one):
- `the 40 open tabs`
- `your candidates vs. the boards`
- `4 hours a day of rewriting the same letter`
...
boring "how much does this cost me" slide up front.
```

## Email 2 — day 3 follow-up (one line)
...
## Email 3 — day 7 value drop (no ask)

```
Hi {{first_name}},

No ask this time — just the one stat that convinced me:

In a real week, the pipeline surfaced 90+ ads for one accountant candidate.
Rules + pre-scoring threw out 85 of them for free. The AI only looked at the
shortlist. That's the economics: judgement at human scale, triage at machine scale.

If you want the 5-min demo at some point, I'm one reply away.

— {{your_name}}
```

## WhatsApp cold message (coach)
