...
| **Solo** | $30 | — | 3 | 100/mo | priority hunt slots |
| **Studio** | $85 | — | 15 | fair-use (20/day/candidate guard-rail) | white-label PDFs, brand header |
| **Sovereign** | $240 | — | unlimited | guard-rail | self-hosted, onboarding day, data never leaves |
...
- **Solo $30** ≈ one bundled CV-and-letter sale at prevailing coach rates (R600–R1 500).
...
- **Studio $85** is priced for throughput, not seats: a CV studio that triples writer
...
- **Sovereign $240** undercuts one junior-recruiter-day and removes the two objections
...
- **Prices are USD, confirmed by the owner 2026-09-19 ($30 / $85 / $240 monthly).** ZW/ZM buyers pay in
...
- "$30 is about one CV bundle at local rates. If Hunta doesn't make you one bundle a month,
