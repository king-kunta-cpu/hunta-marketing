...
| **Solo** | R4,999/mo (R45,000/yr) | 3 candidates, 100 sends/mo |
| **Studio** | R9,999/mo (R90,000/yr) | 15 candidates, white-label PDFs |
| **Sovereign** | R15,000/mo | agency self-hosted, unlimited seats, onboarding day |
...
about Solo at R4,999 a month. Fair?"
```
...
15-18  The three fears, unprompted: no auto-send, no invention, no spam (own mailbox,
       20/day cap).
18-20  "Price is R4,999 a month for three candidates when you're ready. The demo is free forever
...
number four lands and you've only spent one tap on it, R4,999 for three candidates
...
**"It's expensive."** → "The demo is R0 forever. Solo is R4,999/mo — two or three bundled CV-and-letter
...
exact machine for R4,999 a month. One tap: https://whop.com/checkout/ch_psCsZ17A4pnZ4qK/
```

### Upsell Solo→Studio

```
You've maxed three candidates twice this month. Studio is R9,999, fifteen seats,
